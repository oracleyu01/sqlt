...
📝 이론 설명
   ...
   SORT MERGE JOIN은 두 테이블을 정렬한 후 병합하여 조인을 수행하는 방식입니다. 
   HASH 조인을 사용할 수 없거나, 조인 결과를 정렬해야 할 때 유용합니다. 
   정렬 작업으로 인해 추가적인 부담이 있지만, 조인 전에 데이터가 정렬되어 있다면 빠른 조인을 수행할 수 있습니다.
