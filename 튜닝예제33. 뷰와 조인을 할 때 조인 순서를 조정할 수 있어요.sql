...
뷰(View)를 활용한 조인은 SQL 작성 시 직관성을 높이는 동시에 재사용 가능한 데이터 집합을 제공합니다. 
그러나 Query Transformer가 뷰를 해체(Merge)할 경우, 
뷰의 독립성을 유지하지 못하여 실행 계획에 영향을 미칠 수 있습니다. 
힌트를 활용해 뷰의 해체를 방지하고, 조인 순서와 방법을 명확히 지정할 수 있습니다.
